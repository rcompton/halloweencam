...
def mock_glfw():
    ...
    with patch('ghoulfluids.app.glfw') as mock:
        ...
        mock.get_video_mode.return_value = MagicMock(size=MagicMock(width=1920, height=1080))
...
def mock_segmenters():
    ...
    with patch('ghoulfluids.app.YOLOSegmenter') as mock_yolo, \
        ...
        mock_mediapipe.return_value.read_frame_and_mask.return_value = (None, None, None, 0)
